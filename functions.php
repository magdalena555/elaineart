...
function theme_setup() {
	...
	*  sizes with add_image_size. */
	...
	add_image_size('hero', 1050, 700, true);
	add_image_size('portfolio', 300, 300, true);
	add_image_size('single-portfolio', 788, 488, true);
	add_image_size('logo', 200, 100, false);
	add_image_size('home-artwork', 460, 500, true);
	add_image_size('single-artwork', 700, 500, false);
	add_image_size('single-artwork-image', 1250, 500, false);
	add_image_size('single-artwork-thumbnail', 120, 100, true);
	add_image_size('large-square', 450, 300, true);
	add_image_size('studio', 350, 350, true);
